...
public class WebConfig {
    ...
    private String[] getAllowedOrigins() {
        ...
        if ("prod".equalsIgnoreCase(environment)) {
            ...
            return new String[]{"https://159.89.172.251:3085","https://datacollection.deepseahost.com/","https://datacollectionbackend.deepseahost.com/","https://studentpanel.sohojit.com"};
        } else {
